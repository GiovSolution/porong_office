...
//class of bank
class c_bs extends Controller {

	//constructor
	function c_bs(){
		parent::Controller();
		session_start();
		$this->load->model('m_bs', '', TRUE);
	...
	function get_akun_list(){
		$result=$this->m_bs->get_akun_list();
		echo $result;
	}
	...
	function saldo_akhir_list(){
		...
		$result=$this->m_bs->saldo_akhir_list($query,$start,$end);
		echo $result;
	}
	...
	function kas_list(){
		...
		$result=$this->m_bs->kas_list($query,$start,$end);
		echo $result;
	}
	...
	function kas_update(){
		...
		$result = $this->m_bs->kas_update($kas_id , $kas_tanggal, $kas_jumlah , $kas_keterangan, $kas_tipe);
		echo $result;
	}
	...
	function kas_create(){
		...
		$result=$this->m_bs->kas_create($kas_tanggal, $kas_jumlah , $kas_keterangan ,$kas_tipe ,$kas_date_create ,$kas_date_update );
		echo $result;
	}
	...
	function bank_delete(){
		...
		$result=$this->m_bs->bank_delete($pkid);
		echo $result;
	}
	...
	function bank_search(){
		...
		$start = (integer) (isset($_POST['start']) ? $_POST['start'] : $_GET['start']);
		$end = (integer) (isset($_POST['limit']) ? $_POST['limit'] : $_GET['limit']);
		$result = $this->m_bs->bank_search($bank_id ,$bank_kode ,$bank_nama ,$bank_norek ,$bank_atasnama ,$bank_saldo ,$bank_keterangan ,$bank_aktif ,$bank_creator ,$bank_date_create ,$bank_update ,$bank_date_update ,$bank_revised ,$start,$end);
		echo $result;
	}
	...
	function bank_print(){
		...
		$result = $this->m_bs->bank_print($bank_id ,$bank_kode ,$bank_nama ,$bank_norek ,$bank_atasnama ,$bank_saldo ,$bank_keterangan ,$bank_aktif ,$bank_creator ,$bank_date_create ,$bank_update ,$bank_date_update ,$bank_revised ,$option,$filter);
	...
	function bank_export_excel(){
		...
		$query = $this->m_bs->bank_export_excel($bank_id ,$bank_kode ,$bank_nama ,$bank_norek ,$bank_atasnama ,$bank_saldo ,$bank_keterangan ,$bank_aktif ,$bank_creator ,$bank_date_create ,$bank_update ,$bank_date_update ,$bank_revised ,$option,$filter);
