...
class C_kategori extends Controller {
	...
	function kategori_update(){
		...
		$result = $this->m_kategori->kategori_update($kategori_id ,$kategori_nama, $kategori_kode ,$kategori_jenis ,$kategori_keterangan ,$kategori_aktif ,$kategori_creator ,$kategori_date_create ,$kategori_update ,$kategori_date_update ,$kategori_revised );
		echo $result;
	}
	...
	function kategori_create(){
		...
		$kategori_date_update=trim(@$_POST["kategori_date_update"]);
		$kategori_revised=trim(@$_POST["kategori_revised"]);
		$result=$this->m_kategori->kategori_create($kategori_nama, $kategori_kode ,$kategori_jenis ,$kategori_keterangan ,$kategori_aktif ,$kategori_creator ,$kategori_date_create ,$kategori_update ,$kategori_date_update ,$kategori_revised );
		echo $result;
	}
