...
//class of master_retur_bahan
class C_master_retur_bahan extends Controller {

	//constructor
	function C_master_retur_bahan(){
		parent::Controller();
		session_start();
		$this->load->model('m_master_retur_bahan', '', TRUE);
	}
	
	//set index
	function index(){
		$this->load->view('main/v_master_retur_bahan');
	}
	...
	function get_serahbahan_no_list(){
		$query = isset($_POST['query']) ? @$_POST['query'] : "";
		$start = (integer) (isset($_POST['start']) ? @$_POST['start'] : @$_GET['start']);
		$end = (integer) (isset($_POST['limit']) ? @$_POST['limit'] : @$_GET['limit']);
		$result=$this->m_master_retur_beli->get_serahbahan_no_list($query,$start,$end);
		echo $result;
	}
	...
	function  detail_detail_retur_bahan_list(){
		$query = isset($_POST['query']) ? $_POST['query'] : "";
		$start = (integer) (isset($_POST['start']) ? $_POST['start'] : $_GET['start']);
		$end = (integer) (isset($_POST['limit']) ? $_POST['limit'] : $_GET['limit']);
		$master_id = (integer) (isset($_POST['master_id']) ? $_POST['master_id'] : $_GET['master_id']);
		$result=$this->m_master_retur_beli->detail_detail_retur_bahan_list($master_id,$query,$start,$end);
		echo $result;
	}
	//end of handler
