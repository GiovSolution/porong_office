...
class M_kategori extends Model{
		...
		function kategori_update($kategori_id ,$kategori_nama, $kategori_kode ,$kategori_jenis ,$kategori_keterangan ,$kategori_aktif ,$kategori_creator ,$kategori_date_create ,$kategori_update ,$kategori_date_update ,$kategori_revised ){
			if ($kategori_aktif=="")
		...
		function kategori_create($kategori_nama, $kategori_kode ,$kategori_jenis ,$kategori_keterangan ,$kategori_aktif ,$kategori_creator ,$kategori_date_create ,$kategori_update ,$kategori_date_update ,$kategori_revised ){
			if ($kategori_aktif=="")
				$kategori_aktif = "Aktif";
			$data = array(
