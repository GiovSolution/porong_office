...
var terima_carabayarField;
var terima_diskonField;
var terima_biayaField;
var terima_uangmukaField;
var terima_cashbackField;
...
Ext.onReady(function(){
	...
	function master_terima_beli_create(opsi){
		...
		if(terima_tanggalField.getValue()!== ""){terima_tanggal_create_date = terima_tanggalField.getValue().format('Y-m-d');}
		if(terima_diskonField.getValue()!== null){terima_diskon_create = convertToNumber(terima_diskonField.getValue());}
		if(terima_uangmukaField.getValue()!== null){terima_uangmuka_create = convertToNumber(terima_uangmukaField.getValue());}
		if(terima_biayaField.getValue()!== null){terima_biaya_create = convertToNumber(terima_biayaField.getValue());}
		if(terima_cashbackField.getValue()!== null){terima_cashback_create = convertToNumber(terima_cashbackField.getValue());}
		if(terima_totalField.getValue()!== null){terima_total_create = convertToNumber(terima_totalField.getValue());}
		if(terima_totalbayarField.getValue()!== null){terima_bayar_create = convertToNumber(terima_totalbayarField.getValue());}
		if(terima_keteranganField.getValue()!== null){terima_keterangan_create = terima_keteranganField.getValue();}
		if(terima_carabayarField.getValue()!== null){terima_carabayar_create = terima_carabayarField.getValue();}
		if(terima_statusField.getValue()!== null){terima_status_create = terima_statusField.getValue();}
		if(terima_jenisField.getValue()!== null){terima_jenis_create = terima_jenisField.getValue();}
        ...
        if(detail_terima_beli_DataStore.getCount()>0){
            for(i=0; i<detail_terima_beli_DataStore.getCount();i++){
                if((/^\d+$/.test(detail_terima_beli_DataStore.getAt(i).data.dterima_produk))
				   ...
				   && detail_terima_beli_DataStore.getAt(i).data.dterima_keterangan!==''
				   && detail_terima_beli_DataStore.getAt(i).data.dterima_jumlah>0){
					...
					dterima_keterangan.push(detail_terima_beli_DataStore.getAt(i).data.dterima_keterangan);
	...
	function master_terima_beli_reset_form(){
		...
		terima_carabayarField.reset();
		terima_carabayarField.setValue('Kredit');
		terima_diskonField.reset();
		terima_diskonField.setValue('0');
		terima_uangmukaField.reset();
		terima_uangmukaField.setValue('0');		
		terima_biayaField.reset();
		terima_biayaField.setValue('0');
		terima_cashbackField.reset();
		terima_cashbackField.setValue('0');
		terima_statusField.reset();
		terima_statusField.setValue('Terbuka');		
		terima_jenisField.reset();
		terima_jenisField.setValue('PO');
		...
		terima_carabayarField.setDisabled(false);
		terima_diskonField.setDisabled(false);
		terima_uangmukaField.setDisabled(false);
		terima_biayaField.setDisabled(false);
		terima_cashbackField.setDisabled(false);
		terima_statusField.setDisabled(false);
		terima_jenisField.setDisabled(false);
		
		//combo_produk_terima.setDisabled(false);
		//combo_produk_satuan.setDisabled(false);
		dterima_jumlahField.setDisabled(false);
		detail_terima_beliListEditorGrid.setDisabled(false);
	...
	function master_terima_beli_set_form(){
		...
		terima_carabayarField.setValue(master_terima_beliListEditorGrid.getSelectionModel().getSelected().get('terima_carabayar'));
		terima_diskonField.setValue(CurrencyFormatted(master_terima_beliListEditorGrid.getSelectionModel().getSelected().get('terima_diskon')));
		terima_uangmukaField.setValue(CurrencyFormatted(master_terima_beliListEditorGrid.getSelectionModel().getSelected().get('terima_uangmuka')));
		terima_biayaField.setValue(CurrencyFormatted(master_terima_beliListEditorGrid.getSelectionModel().getSelected().get('terima_biaya')));
		terima_cashbackField.setValue(CurrencyFormatted(master_terima_beliListEditorGrid.getSelectionModel().getSelected().get('terima_cashback')));
		terima_statusField.setValue(master_terima_beliListEditorGrid.getSelectionModel().getSelected().get('terima_status'));
		terima_jenisField.setValue(master_terima_beliListEditorGrid.getSelectionModel().getSelected().get('terima_jenis'));
		...
		if(terimabeli_post2db=="UPDATE" && master_terima_beliListEditorGrid.getSelectionModel().getSelected().get('terima_status')=="Tertutup"){
			...
			terima_carabayarField.setDisabled(true);
			terima_diskonField.setDisabled(true);
			terima_uangmukaField.setDisabled(true);
			terima_biayaField.setDisabled(true);
			terima_cashbackField.setDisabled(true);
			terima_statusField.setDisabled(false);
			terima_jenisField.setDisabled(true);
			detail_terima_beliListEditorGrid.setDisabled(true);
...
//			header: 'No.Surat Jalan',
	...
	master_terima_beliListEditorGrid =  new Ext.grid.EditorGridPanel({
		...
		<?php } ?>
		{
			...
			listeners:{
				...
				Ext.get(this.id).set({qtip:'- No OP<br>- No PB<br>- Supplier<br>- No Kendaraan<br>- Driver'});
				}
			},
			width: 120
		}),'-',{
	...
	terima_diskonField= new Ext.form.TextField({
		id: 'terima_diskonField',
		fieldLabel: 'Diskon (%)',
	...
	terima_uangmukaField= new Ext.form.TextField({
		id: 'terima_uangmukaField',
	...
	terima_biayaField= new Ext.form.TextField({
		id: 'terima_biayaField',
		fieldLabel: 'Biaya (Rp)',
		valueRenderer: 'numberToCurrency',
		itemCls: 'rmoney',
		enableKeyEvents: true,
	...
	terima_cashbackField= new Ext.form.TextField({
		id: 'terima_cashbackField',
	...
	terima_carabayarField= new Ext.form.ComboBox({
		id: 'terima_carabayarField',
	...
	terima_totalField= new Ext.form.TextField({
		id: 'terima_totalField',	
	...
	terima_totalbayarField= new Ext.form.TextField({
		id: 'terima_totalbayarField',
	...
	terima_jenisField= new Ext.form.ComboBox({
		id: 'terima_jenisField',
	...
	var dterima_hargaField = new Ext.form.NumberField({
		id : 'dterima_hargaField',
		name : 'dterima_hargaField',
		allowDecimals: false,
		allowNegative: false,
		enableKeyEvents: true,
		//blankText: '0',
	...
	var dterima_diskonField = new Ext.form.NumberField({
		id : 'dterima_diskonField',
		name : 'dterima_diskonField',
		allowDecimals: true,
		allowNegative: false,
		enableKeyEvents: true,
		//blankText: '0',
	...
	var dterima_keteranganField = new Ext.form.TextField({
		id : 'dterima_keteranganField',
		name : 'dterima_keteranganField',
		//allowDecimals: false,
		//allowNegative: false,
		//enableKeyEvents: true,
		//blankText: '0',
	...
	master_terima_beli_masterGroup = new Ext.form.FieldSet({
		...
		items:[
			...
			,
			{
				...
				layout: 'form',
				border:false,
				items: [terima_pengirimField, terima_tanggalField, terima_keteranganField, /*terima_jenisField, */ terima_statusField,terima_idField]
			}
			]
		...
		items:[
			{
				...
				border:false,
				labelWidth: 130,
				items: [terima_jumlahField, terima_itemField, terima_totalField]
			},
			{
				columnWidth:0.5,
				layout: 'form',
				...
				border:false,
				labelWidth: 130,
				items: [terima_carabayarField, terima_diskonField, terima_cashbackField, terima_biayaField, terima_uangmukaField, terima_totalbayarField]
			}
			]
	...
	detail_terima_beli_ColumnModel = new Ext.grid.ColumnModel(
		...
		},
		{
			...
			width: 100,
			sortable: true,
			editor : dterima_keteranganField
			//renderer: Ext.util.Format.numberRenderer('0,000'),
			//readOnly: true
		}
		,{
	...
	function detail_terima_beli_total(){
		...
		var diskon=convertToNumber(terima_diskonField.getValue())*total_harga/100;
		terima_totalField.setValue(CurrencyFormatted(total_harga));
		terima_totalbayarField.setValue(CurrencyFormatted(total_harga+convertToNumber(terima_biayaField.getValue())-convertToNumber(terima_uangmukaField.getValue())-convertToNumber(terima_cashbackField.getValue())-diskon));
	}
	...
	terima_uangmukaField.on("keyup",detail_terima_beli_total);
	terima_biayaField.on("keyup",detail_terima_beli_total);
	terima_cashbackField.on("keyup",detail_terima_beli_total);
	terima_diskonField.on("keyup",detail_terima_beli_total);
	...
	terima_orderField.on("select",function(){
		...
		tbeli_orderbeli_detail_DataStore.setBaseParam('order_id', terima_orderField.getValue());
